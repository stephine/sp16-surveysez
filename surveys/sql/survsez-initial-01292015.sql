...
DROP TABLE IF EXISTS wn15_responses_answers; 
DROP TABLE IF EXISTS wn15_responses;
DROP TABLE IF EXISTS wn15_answers;
...
INSERT INTO wn15_surveys VALUES (NULL,1,'Our First Survey','Description of Survey',NOW(),NOW(),0,0); 
...
INSERT INTO wn15_questions VALUES (NULL,1,'Do You Like Cookies?','We like cookies!',NOW(),NOW());
INSERT INTO wn15_questions VALUES (NULL,1,'Favorite Toppings?','We like chocolate!',NOW(),NOW());


CREATE TABLE wn15_answers(
...
FOREIGN KEY (QuestionID) REFERENCES wn15_questions(QuestionID) ON DELETE CASCADE
)ENGINE=INNODB;

INSERT INTO wn15_answers VALUES (NULL,1,'Yes','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,1,'No','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,2,'Yes','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,2,'No','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,2,'Maybe','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,3,'Chocolate','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,3,'Butterscotch','',NOW(),NOW(),0);
INSERT INTO wn15_answers VALUES (NULL,3,'Pineapple','',NOW(),NOW(),0);
...
INSERT INTO wn15_responses VALUES (NULL,1,NOW());


CREATE TABLE wn15_responses_answers(
...
FOREIGN KEY (ResponseID) REFERENCES wn15_responses(ResponseID) ON DELETE CASCADE
)ENGINE=INNODB;

INSERT INTO wn15_responses_answers VALUES (NULL,1,1,1);
INSERT INTO wn15_responses_answers VALUES (NULL,1,2,5);
INSERT INTO wn15_responses_answers VALUES (NULL,1,3,6);
INSERT INTO wn15_responses_answers VALUES (NULL,1,3,7);
INSERT INTO wn15_responses_answers VALUES (NULL,1,3,8);
